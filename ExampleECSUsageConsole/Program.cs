...
//            await builder.AddEntity().WithComponentAsync<TestComponent>(true);
...
namespace GuessingGame
{
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            await builder.AddEntity().WithComponentAsync<PlayerComponent>();
            await builder.AddEntity().WithComponentAsync<PlayerComponent>();
            await builder.AddEntity().WithComponentAsync<RoundComponent>();
            await builder.StartGame();
        }
    }
